  ...
  return (
    <div className="max-w-md mx-auto text-center py-16 page-enter">
      ...
      <p className="text-charcoal/60 mt-2">
        Your eSewa payment was cancelled or failed. No money has been deducted from your account.
      </p>
      ...
      <div className="flex gap-3 justify-center mt-6">
        ...
        <Link to="/customer/medicines" className="rounded-lg border border-charcoal/20 text-charcoal px-6 py-2.5 font-medium hover:bg-charcoal/5">
          Continue Shopping
        </Link>
      </div>
    </div>
